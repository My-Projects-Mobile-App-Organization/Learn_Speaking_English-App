 ...
 * Use the {@link WordPairingFragmentVocab#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WordPairingFragmentVocab extends Fragment {
    ...
    public WordPairingFragmentVocab() {
     ...
     * @return A new instance of fragment WordPairingFragment_Vocab.
     */
    // TODO: Rename and change types and number of parameters
    public static WordPairingFragmentVocab newInstance(String param1, String param2) {
        WordPairingFragmentVocab fragment = new WordPairingFragmentVocab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_word_pairing__vocab, container, false);
        ...
        for (String key : keys){
            addView((FlowLayout) mView.findViewById(R.id.wordPairingLayout), key, editText);
        }
...
//                SetupDataAdapterWordPairing();
    ...
    private void SetupDataAdapterWordPairing() {
        ...
        presCounter = 0;
        FlowLayout layout = (FlowLayout) mView.findViewById(R.id.wordPairingLayout);
    ...
    private void addView(FlowLayout viewParent, final String text, final EditText editText) {
        ...
        textView.setBackground(this.getResources().getDrawable(R.drawable.background_shadow__board_button));
...
//        textView.setTypeface(typeface);
    ...
    private void AnhXa(){
        ...
        editText = (EditText) mView.findViewById(R.id.editTextAns);
